...
WebUI.sendKeys(findTestObject('Contact/input_Email_Contact'), email)
...
WebUI.sendKeys(findTestObject('Contact/input_Name_Contact'), name)
...
WebUI.sendKeys(findTestObject('Contact/txt_Message_Contact'), message)
